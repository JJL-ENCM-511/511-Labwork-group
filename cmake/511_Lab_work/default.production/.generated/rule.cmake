...
function(A_511_Lab_work_default_default_XC16_assemble_rule target)
    set(options
        "-g"
        "-mcpu=24FJ256GA702"
        "-Wa,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUGGER_SNAP=1,--no-relax")
...
function(A_511_Lab_work_default_link_rule target)
    set(options
        "-g"
        "-mcpu=24FJ256GA702"
        "-Wl,--script=p24FJ256GA702.gld,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUGGER_SNAP=1,--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,--report-mem,--memorysummary,memoryfile.xml")
    list(REMOVE_ITEM options "")
